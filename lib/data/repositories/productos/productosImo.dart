...
class ProductosImp implements AbstractProductos {
  ...
  @override
  Future<Either<Failure, List<ProductosEntity>>>
      getAllProductosActivos() async {
    try {
      return right(await datasource.getAllProductosActivos());
    } on ServerException {
      return left(ServerFailure(mensaje: "Error al obtener lista de grupos"));
    }
  }
  ...
  Future<Either<Failure, ProductosEntity>> updateProductos(
      ProductosModel dep) async {
    try {
      return right(await datasource.updateProductos(dep));
    } on ServerException {
      return left(ServerFailure(mensaje: "Error al obtener lista de grupos"));
    }
  }
